...
import DashboardService from '../../services/DashboardService'; // getActivityList
import { getToken, getSelectOptions } from '../../reducers';
import SessionStorage from '../../utils/SessionStorage';

/**
 * Basic BookingPage react component.
 */
...
export default withRouter(connect(BookingPage.mapStateToProps)(BookingPage));
